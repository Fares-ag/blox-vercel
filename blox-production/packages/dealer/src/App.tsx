...
import { AppRoutes } from './modules/dealer/routes/AppRoutes';
...
import { AuthInitializer } from './modules/dealer/components/AuthInitializer';
    ...
    <ErrorBoundary>
      <Provider store={store}>
        <ThemeProvider theme={theme}>
          <CssBaseline />
          <BrowserRouter>
            <PortalBasePathProvider basePath="/dealer">
              <ScrollToTop />
              <AuthInitializer />
              <Box className="dealer-app-wrapper">
