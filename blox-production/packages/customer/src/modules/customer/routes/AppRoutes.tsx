...
const ApplicationConfirmationPage = React.lazy(() => import('../features/applications/pages/ApplicationConfirmationPage/ApplicationConfirmationPage').then(m => ({ default: m.ApplicationConfirmationPage })));
...
export const AppRoutes: React.FC = () => {
  return (
    <Routes>
      ...
      {/* Application Confirmation - Public (new users land here after submit) */}
      <Route
        path="/customer/applications/confirmation"
        element={
          <CustomerNavWrapper>
