...
import { AppRoutes } from './modules/credit/routes/AppRoutes';
...
import { AuthInitializer } from './modules/credit/components/AuthInitializer';
    ...
    <ErrorBoundary>
      <Provider store={store}>
        <ThemeProvider theme={theme}>
          <CssBaseline />
          <BrowserRouter>
            <PortalBasePathProvider basePath="/credit">
              <ScrollToTop />
              <AuthInitializer />
              <Box className="credit-app-wrapper">
