-- customer_pay_installment_with_credits inserts into payment_transactions.application_id (TEXT).
-- Original migration used p_application_id::uuid which breaks after TEXT application ids.
...
BEGIN
  ...
  INSERT INTO public.payment_transactions (
    ...
    p_application_id, v_schedule.id, p_amount, 'blox_credit', 'completed', v_txn_id, v_paid_at
  );
