...
-- ============================================
-- Versioned migration. Bucket `documents` must exist and be PRIVATE.
-- FORBIDDEN in production: open policies like
--   USING (bucket_id = 'documents') for all authenticated
-- without ownership checks (see STORAGE_SETUP_GUIDE insecure fallback — do not use).
-- ============================================
